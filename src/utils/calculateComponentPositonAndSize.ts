...
function calculateLeftTop(style:Style, curPositon: Point, proportion: number, needLockProportion: boolean, pointInfo: any) {
...
function calculateRightTop(style:Style, curPositon: Point, proportion: number, needLockProportion: boolean, pointInfo: any) {
  const { symmetricPoint } = pointInfo
  let newCenterPoint = getCenterPoint(curPositon, symmetricPoint)
...
function calculateRightBottom(style:Style, curPositon: Point, proportion: number, needLockProportion: boolean, pointInfo: any) {
  const { symmetricPoint } = pointInfo
  let newCenterPoint = getCenterPoint(curPositon, symmetricPoint)
...
function calculateLeftBottom(style:Style, curPositon: Point, proportion: number, needLockProportion: boolean, pointInfo: any) {
  const { symmetricPoint } = pointInfo
  let newCenterPoint = getCenterPoint(curPositon, symmetricPoint)
...
function calculateTop(style:Style, curPositon: Point, proportion: number, needLockProportion: boolean, pointInfo: any) {
...
function calculateRight(style:Style, curPositon: Point, proportion: number, needLockProportion: boolean, pointInfo: any) {
  const { symmetricPoint, curPoint } = pointInfo
  const rotatedcurPositon = calculateRotatedPointCoordinate(curPositon, curPoint, -style.rotate)
...
function calculateBottom(style:Style, curPositon: Point, proportion: number, needLockProportion: boolean, pointInfo: any) {
  const { symmetricPoint, curPoint } = pointInfo
  const rotatedcurPositon = calculateRotatedPointCoordinate(curPositon, curPoint, -style.rotate)
...
function calculateLeft(style:Style, curPositon: Point, proportion: number, needLockProportion: boolean, pointInfo: any) {
  const { symmetricPoint, curPoint } = pointInfo
  const rotatedcurPositon = calculateRotatedPointCoordinate(curPositon, curPoint, -style.rotate)
...
export default function calculateComponentPositonAndSize(name: string, style:Style, curPositon: Point, proportion: number, needLockProportion: boolean, pointInfo: any) {
